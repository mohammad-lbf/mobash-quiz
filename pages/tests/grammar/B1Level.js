    ...
    return (
        <div className='page-padding-tops'>
                <Head>
                    ...
                    <meta name="og:title" content="Mobash Academy | سطح B1 | آزمون تعیین سطح گرامر" />
                    ...
                    <title>Mobash Academy | سطح B1 | آزمون تعیین سطح گرامر</title>
                </Head>
                    ...
                    <div className='row pt-3 justify-content-center'>
                        ...
                        {testName}
                            ...
                            <h5 style={{fontSize:"24px",color:"#464749" , 
                                ...
                                textAlign:"justify" , 
                                fontFamily:"KalamehWeb-Medium"}} 
                                className='border-bottom pb-2 mb-2'>1.	تعداد سوالات این بخش در هر سطح ۹ سوال و حداکثر مدت زمان پاسخگویی ۱۵ دقیقه خواهد بود.</p>
                                <p 
                                style={{fontSize:"15px" , 
                                color:"#474d52" ,lineHeight:"2em" , 
                                textAlign:"justify" , 
                                ...
                                textAlign:"justify" , 
                                fontFamily:"KalamehWeb-Medium"}} 
                                className='border-bottom pb-2 mb-2'>3.	با کسب نمره قبولی در این مرحله می‌توانید آزمون را در سطح بالاتر  (B1 plus) ادامه دهید.</p>
                            </div> 
                        </div>
                    </div>
