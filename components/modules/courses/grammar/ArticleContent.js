...
<Paragraph>برای شرکت در آزمون تعیین سطح گرامر کلیک کنید.</Paragraph>

<MainTitle>سوالات متداول:</MainTitle>
<SubTitle>چه موضوعاتی در این دوره آموزش داده می‌شود؟</SubTitle>
<Paragraph>وابسته به نیاز زبان آموز, تمامی مباحث گرامری از سطح مبتدی (A1) تا پیشرفته (C2) آموزش داده خواهد شد.</Paragraph>

<SubTitle>چقدر زمان لازم است تا این دوره را به پایان برسانم؟</SubTitle>
...
<SubTitle>شیوه برگزاری دوره چگونه است؟</SubTitle>
<Paragraph>تمامی کلاس‌ها بصورت آنلاین, خصوصی و در بستر پلتفرم اسکای روم برگزار می‌شوند.</Paragraph>

<SubTitle>منابع و کتاب‌های درسی این دوره چیست؟</SubTitle>
...
<SubTitle>چگونه می‌توانم در این دوره ثبت نام کنم؟</SubTitle>
