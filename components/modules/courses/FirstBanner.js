            ...
            <div className='container'>
                <div className='row align-items-center align-items-lg-start justify-content-center pt-md-4'>
                    ...
                    <div className='d-flex flex-column justify-content-center justify-content-lg-start'>
                        ...
                        <Image style={{borderRadius:"10px"}} className='img-fluid border d-lg-none' alt='courses-coverphoto' width={1305} height={683} src={'/images/courses/courses-banner.jpg'} />
                    </div>
                    ...
                    <Image style={{borderRadius:"10px"}} className='img-fluid d-none d-lg-flex' alt='html-logo' width={1305} height={683} src={'/images/courses/courses-banner.jpg'} />
                    </div>
                </div>
            </div>
        </div>
