...
const GrammarTestLevel = ({level , pastLevel ,name , userStatus , userMark , pastLevelStatus}) => {
    return (
        ...
        </div>
        {
            ...
            userStatus =="failed" && <Link class="btn btn-danger d-inline-block text-white mt-3 mt-sm-0 d-flex align-items-center justify-content-center" style={{width:"130px" , height:"40px"}} href={`/tests/grammar/${level}Level`}>آزمون مجدد</Link>
        }
        </div>
    </div>
    );
