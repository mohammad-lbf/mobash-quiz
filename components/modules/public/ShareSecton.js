    ...
    return (
        <div style={{borderRadius:"15px"}} className='bg-gray-850 border-gray-800 p-3 my-4 d-flex justify-content-lg-between flex-column flex-lg-row align-items-center'>
            ...
            <div className='d-flex'>
                ...
                target={'_blank'}
                rel="noreferrer"
                href={`https://t.me/share/url?url=https://www.mobash.ir/tests/public`}>
                ...
                target={'_blank'}
                rel="noreferrer"
                href={`whatsapp://send/?text=https://www.mobash.ir/tests/public`}>
                ...
                target={'_blank'}
                rel="noreferrer"
                href={`https://www.linkedin.com/sharing/share-offsite/?url=https://www.mobash.ir/tests/public`}>
